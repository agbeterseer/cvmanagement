<?php $__env->startSection('content'); ?>
 ...
 <img src="/uploads/avatars/<?php echo e($user->avatar); ?>" class="img-responsive" alt="" > 
 </div>
                                        <!-- END SIDEBAR USERPIC -->
                                        <!-- SIDEBAR USER TITLE -->
                                        <div class="profile-usertitle">
                                            <div class="profile-usertitle-name"> <?php echo e($user->name); ?>'s Profile </div>
                          ...
                          <!--               <div class="row list-separated profile-stat">
                                        ...
                                        <!-- END STAT -->
                                        <div>
                                            <h4 class="profile-desc-title">About <?php echo e($user->name); ?></h4>
...
<div class="portlet-body">
   ...
   <form role="form" action="<?php echo e(url('/user/profile')); ?>" method="PATCH">
            <?php echo e(csrf_field()); ?> 
                <div class="form-group">
                    <label class="control-label">Full Name</label>
                    <input type="text" name="firstname" required="required" readonly="readonly"  class="form-control" value="<?php echo e($user->name); ?>" /> </div>
 <!--                <div class="form-group">
                    <label class="control-label">Last Name</label>
                    <input type="text" name="lastname" required="required" class="form-control" value="<?php echo e(str_limit($user->name, 7)); ?>" readonly="readonly" /> </div> -->
...
<form action="<?php echo e(url('/user/profile')); ?>" role="form" enctype="multipart/form-data" method="POST">
          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <div class="form-group">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
   <img src="/uploads/avatars/<?php echo e($user->avatar); ?>"  alt="" width=" 300px" height="300px" /> </div>
...
<!-- <form  id="tab_1_3" class="form-horizontal" method="POST" action="<?php echo e(url('/user/password')); ?>"> -->
            <?php echo e(csrf_field()); ?> 
