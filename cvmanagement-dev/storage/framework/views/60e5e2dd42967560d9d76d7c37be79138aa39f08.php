<div class="page-sidebar-wrapper">
                      ...
                      <div class="page-sidebar navbar-collapse collapse">
                          ...
                          <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <!--       <form class="sidebar-search" action="<?php echo e(route('document.index')); ?>" method="POST">
                 ...
                 <input type="text" class="form-control" name="s"placeholder="Search...">
                              ...
                              <a href="<?php echo e(route('board')); ?>" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                      ...
                      <li class="nav-item  " id="roleid">
                              ...
                              <?php endif; ?>
                                  ...
                                  <ul class="sub-menu">
                                      ...
                                      <li class="nav-item ">
                                          ...
                                          <li class="nav-item ">
                                          <a href="<?php echo e(route('document.uploadfromcsv')); ?>" class="nav-link ">
                                              <span class="title">Upload CV From CSV</span>
                                          </a>
                                      </li>
                                       <li class="nav-item ">
                                          <a href="<?php echo e(route('document.search_category')); ?>" class="nav-link ">
                                              <span class="title">Document Search</span>
                                          </a>
                                      </li>
                                 <!--         <li class="nav-item ">
                                          <a href="<?php echo e(route('region.index')); ?>" class="nav-link ">
                                              <span class="title">
                              ...
                              <li class="nav-item  ">
                                  ...
                                  <ul class="sub-menu">
                                      ...
                                      <li class="nav-item ">
                                          <a href="<?php echo e(route('backupsys.importExport')); ?>" class="nav-link ">
                                        <span class="title">Back up cv </span>
                                          </a>
                                      </li>
                                             <li class="nav-item ">
                                          <a href="<?php echo e(route('backupsys.backups')); ?>" class="nav-link ">
                                        <span class="title">Back up cv </span>
                                          </a>
                                      </li>
